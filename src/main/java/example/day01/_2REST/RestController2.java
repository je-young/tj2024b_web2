...
public class RestController2 {
    ...
    // [1] @ResponseBody
    // - 메소드의 반환(return) 값을 HTTP 응답 본문(body) 으로 application/json 타입으로 응답 자동으로 변환
    ...
    // @ResponseBody // 자동으로 함수 return 값을 HTTP response 를 application/json 형태로 변환
    ...
    public Map<String, String> doGet5() {
        ...
        map.put("name", "강호동");
        return map; // (200) application/json : {"name":"강호동"}
    }

    @GetMapping("/doget6") // http://localhost:8080/day01/doget6
    // @ResponseBody
    public boolean doGet6() { return true; } // (200) application/json : true
